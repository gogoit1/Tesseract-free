...
global $pagenow;
//echo $pagenow;
	if ( ! is_plugin_active( 'tesseract-pro-plugin/fl-builder.php' ) && $pagenow == 'about.php' ) {
...
<?php
	...
	} elseif ( ! is_plugin_active( 'tesseract-pro-plugin/fl-builder.php' ) ) {
		if ( false === ( $dismissed = get_transient( 'dismiss_tesseractpls' ) ) ) {
?>
		<div id="tesseract-pro-plugin-notice" class="updated notice custom-notice">
			<?php
	...
	public static function header_output() {
		...
		<style type='text/css'>
			.top-navigation ul ul li > a{
				color:<?php echo get_theme_mod('sub_menu_color'); ?> ;
			}
		</style>
	<?php
	}
